...
public class MyWebpage {
    ...
    public MyWebpage setStaticFields(Map<String, Object> staticFields) {
    ...
    public MyWebpage setNamedEntity(Map<String, Set<String>> namedEntity) {
    ...
    public MyWebpage setKeywords(List<String> keywords) {
    ...
    public MyWebpage setSummary(List<String> summary) {
    ...
    public MyWebpage setPublishTime(long publishTime) {
    ...
    public MyWebpage setCategory(String category) {
    ...
    public MyWebpage setRawHTML(String rawHTML) {
    ...
    public MyWebpage setDynamicFields(Map<String, Object> dynamicFields) {
    ...
    public MyWebpage setAttachmentList(List<String> attachmentList) {
    ...
    public MyWebpage setImageList(List<String> imageList) {
    ...
    public MyWebpage setProcessTime(long processTime) {
